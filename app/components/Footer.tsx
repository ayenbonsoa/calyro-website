...
export default function Footer() {
    return (
         <div className="relative bg-white">
            <div className="px-12 sm:px-32 pt-12 pb-12 lg:flex w-full space-y-12 text-[#C2983E]">
                <div className="w-full lg:w-6/12 space-y-6">
                    <h3 className="text-lg font-base">Calyro propose une solution sous la forme d’un service intermédiaire de retrait
                        ...
                        procédons ensuite à la connexion de notre carte PayPal Business vérifiée afin
                ...
                <div className="w-full lg:w-6/12 lg:flex lg:justify-center">

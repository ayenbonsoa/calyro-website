...
const App = () => {
    ...
    const CreateCard = ({ card }: { card: Card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 text-[#C2983E]">
            <div className="flex gap-2 ">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-[#C2983E]">{card.handle}</span>
                </div>
            </div>
            <p className="text-sm py-4 text-gray-800">{card.testimonial}</p>
            <div className="flex items-center justify-between text-[#C2983E] text-xs">
                <div className="flex items-center gap-1">
